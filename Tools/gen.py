...
def get_proto_path() -> ProtoInfo:
    ...
    if os.name == "nt":
        info.protoc_path = "bin/windows_x64/protoc.exe"
        # csharp
        info.csharp_grpc = "./bin/windows_x64/grpc_csharp_plugin.exe"

        # golang
        info.golang_protoc = "./bin/windows_x64/protoc-gen-go.exe"
        info.golang_grpc = "./bin/windows_x64/protoc-gen-go-grpc.exe"
    else:
